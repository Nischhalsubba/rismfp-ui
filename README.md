...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/fix-post-merge-verification`](https://github.com/Nischhalsubba/rismfp-ui/tree/agent/fix-post-merge-verification). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/fix-post-merge-verification"]
