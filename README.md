...
**Branch-aware technical guide for [`dependabot/npm_and_yarn/hosted-git-info-2.8.9`](https://github.com/Nischhalsubba/rismfp-ui/tree/dependabot/npm_and_yarn/hosted-git-info-2.8.9)**

<p><img alt="branch: dependabot/npm_and_yarn/hosted-git-info-2.8.9" src="https://img.shields.io/static/v1?label=&message=branch%3A%20dependabot%2Fnpm_and_yarn%2Fhosted-git-info-2.8.9&color=5965F2&style=flat-square"> <img alt="Sass" src="https://img.shields.io/static/v1?label=&message=Sass&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/rismfp-ui/tree/dependabot/npm_and_yarn/hosted-git-info-2.8.9"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/rismfp-ui/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/rismfp-ui/codespaces/new?ref=dependabot%2Fnpm_and_yarn%2Fhosted-git-info-2.8.9"><strong>Open in Codespaces</strong></a>
</p>
...
- [`README.md`](https://github.com/Nischhalsubba/rismfp-ui/blob/dependabot/npm_and_yarn/hosted-git-info-2.8.9/README.md)
- [`package-lock.json`](https://github.com/Nischhalsubba/rismfp-ui/blob/dependabot/npm_and_yarn/hosted-git-info-2.8.9/package-lock.json)
...
```mermaid
flowchart TD
    ROOT["rismfp-ui / dependabot/npm_and_yarn/hosted-git-info-2.8.9"]
    ROOT --> P0["assets/"]
    ROOT --> P1["src/"]
    ROOT --> P2[".gitignore"]
    ROOT --> P3["_config.yml"]
...
|---|---|
| Interface | [`src`](https://github.com/Nischhalsubba/rismfp-ui/tree/dependabot/npm_and_yarn/hosted-git-info-2.8.9/src) |
...
```mermaid
flowchart LR
    CHANGE["Change on dependabot/npm_and_yarn/hosted-git-info-2.8.9"] --> CHECK["Tests and quality checks"]
...
| Branch | [`dependabot/npm_and_yarn/hosted-git-info-2.8.9`](https://github.com/Nischhalsubba/rismfp-ui/tree/dependabot/npm_and_yarn/hosted-git-info-2.8.9) |
