...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`dependabot/npm_and_yarn/hosted-git-info-2.8.9`](https://github.com/Nischhalsubba/rismfp-ui/tree/dependabot/npm_and_yarn/hosted-git-info-2.8.9). It is generated from the files present on this branch and preserves the project-authored README below.
...
flowchart TD
    ...
    ROOT --> P7["gulpfile.js"]
    ROOT --> P8["index.html"]
    ROOT --> P9["index_old.html"]
    ROOT --> P10["introduction.html"]
    ROOT --> P11["news.html"]
    ROOT --> P12["package-lock.json"]
    ROOT --> P13["package.json"]
    ROOT --> P14["web-based-mis.html"]
```
...
```mermaid
flowchart LR
    CHANGE["Change on dependabot/npm_and_yarn/hosted-git-info-2.8.9"]
