...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`dependabot/npm_and_yarn/ajv-6.12.6`](https://github.com/Nischhalsubba/rismfp-ui/tree/dependabot/npm_and_yarn/ajv-6.12.6). It is generated from the files present on this branch and preserves the project-authored README below.
