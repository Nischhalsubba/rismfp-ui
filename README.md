...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`dependabot/npm_and_yarn/copy-props-2.0.5`](https://github.com/Nischhalsubba/rismfp-ui/tree/dependabot/npm_and_yarn/copy-props-2.0.5). It is generated from the files present on this branch and preserves the project-authored README below.
