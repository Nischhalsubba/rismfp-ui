...
**Branch-aware technical guide for [`agent/final-qa-stabilization`](https://github.com/Nischhalsubba/rismfp-ui/tree/agent/final-qa-stabilization)**

<p><img alt="branch: agent/final-qa-stabilization" src="https://img.shields.io/static/v1?label=&message=branch%3A%20agent%2Ffinal-qa-stabilization&color=5965F2&style=flat-square"> <img alt="HTML" src="https://img.shields.io/static/v1?label=&message=HTML&color=24292F&style=flat-square"> <img alt="CSS" src="https://img.shields.io/static/v1?label=&message=CSS&color=24292F&style=flat-square"> <img alt="JavaScript" src="https://img.shields.io/static/v1?label=&message=JavaScript&color=24292F&style=flat-square"> <img alt="license detected" src="https://img.shields.io/static/v1?label=&message=license%20detected&color=2DA44E&style=flat-square"> <img alt="docs: branch-aware" src="https://img.shields.io/static/v1?label=&message=docs%3A%20branch-aware&color=8250DF&style=flat-square"></p>

<p>
  <a href="https://github.com/Nischhalsubba/rismfp-ui/tree/agent/final-qa-stabilization"><strong>Browse source</strong></a> ·
  <a href="https://github.com/Nischhalsubba/rismfp-ui/issues"><strong>Issues</strong></a> ·
  <a href="https://github.com/Nischhalsubba/rismfp-ui/codespaces/new?ref=agent%2Ffinal-qa-stabilization"><strong>Open in Codespaces</strong></a>
</p>

</div>

> [!IMPORTANT]
> This guide is generated from the files actually present on `agent/final-qa-stabilization`. It links to detected source paths, preserves project-authored notes, and avoids claiming components that were not found.
...
- [`README.md`](https://github.com/Nischhalsubba/rismfp-ui/blob/agent/final-qa-stabilization/README.md)
...
|---|---|
| Delivery | [`.github`](https://github.com/Nischhalsubba/rismfp-ui/tree/agent/final-qa-stabilization/.github), [`scripts`](https://github.com/Nischhalsubba/rismfp-ui/tree/agent/final-qa-stabilization/scripts) |
...
```mermaid
flowchart LR
    CHANGE["Change on agent/final-qa-stabilization"] --> CHECK["Tests and quality checks"]
...
- [`.github/workflows/quality.yml`](https://github.com/Nischhalsubba/rismfp-ui/blob/agent/final-qa-stabilization/.github/workflows/quality.yml)
...
| License | [`LICENSE`](https://github.com/Nischhalsubba/rismfp-ui/blob/agent/final-qa-stabilization/LICENSE) |
