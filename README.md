...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/fix-hero-cutouts-and-qa`](https://github.com/Nischhalsubba/rismfp-ui/tree/agent/fix-hero-cutouts-and-qa). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/fix-hero-cutouts-and-qa"]
