...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`agent/refine-typography-readme`](https://github.com/Nischhalsubba/rismfp-ui/tree/agent/refine-typography-readme). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart LR
    CHANGE["Change on agent/refine-typography-readme"]
